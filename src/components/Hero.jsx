...
function Hero  (){
    ...
    <div className='bg-black'>
      <div className="relative flex items-center justify-between h-[100svh] px-4 md:px-10 overflow-hidden bg-black pt-16 md:pt-20">
       ...
       <div className='scroll-container opacity-20'>
            <div className='text-[140px] md:text-[360px] lg:text-[550px] flex font-semibold text-white tracking-tighter'>
            <div>H</div>
            <div>E</div>
            <div>M</div>
            <div>E</div>
       ...
       <div className='absolute top-50 transform -translate-y-1/2'>
          ...
          >
          <p className= 'bg-gradient-to-r from-white/10 to-white bg-clip-text text-transparent opacity-80 text-[50px] md:text-[80px] lg:text-[70px] sm:text-[60px] font-semibold uppercase'>fresh summer</p>
 ...
 "
    ...
    <motion.div
      ...
      className="absolute -bottom-10 lg:bottom-20 md:bottom-20 lg:left-70 md:left-50
                 text-white/80 uppercase font-bold
                 text-[20px] sm:text-[30px] md:text-[30px] lg:text-[30px]
                 space-y-2 z-100 border-none w-[400px] top-2/3 "
    >
  ...
  <div className="bg-black min-h-screen px-6 md:px-12 lg:px-24 py-2 md:py-20">
    ...
    <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
      ...
      <div className="flex-1 uppercase font-extrabold 
                      text-[20px] md:text-[40px] lg:text-[50px] 
