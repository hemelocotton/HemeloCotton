...
function MobileMenu({ onNavigate }) {
  ...
  <button
    ...
    className="p-2 rounded-md border border-gray-800 dark:border-white 
  ...
  >
    <div className="flex flex-col gap-4 px-6 py-6 
      ...
      <button
        className="text-left opacity-60 hover:opacity-100 uppercase"
        onClick={() => {
          onNavigate("home");
          setOpen(false);
        }}
      ...
      <button className="text-left opacity-60 hover:opacity-100">
        BOOK
      </button>
